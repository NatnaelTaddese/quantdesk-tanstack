...
function PortfolioPage() {
	...
	const [_editingPosition, _setEditingPosition] = useState<number | null>(null)
	const [_riskPanelExpanded, _setRiskPanelExpanded] = useState(true)
						...
						<div className="space-y-0">
							...
							{mockPortfolioHistory
								...
								.map((h, i, arr) => {
									...
									const _dayPnlPct = (dayPnl / prevValue) * 100
									return (
										<div
											key={h.date}
